...
(function () {
  const BOOK_I18N = {
    ka: {
      ...
      demo_note: 'ℹ️ თქვენი ჯავშანი მყისიერად ინახება და არჩეული დრო მაშინვე იკეტება ყველასთვის.',
    ...
    en: {
      ...
      demo_note: 'ℹ️ Your booking is saved instantly and the chosen time then closes for everyone.',
